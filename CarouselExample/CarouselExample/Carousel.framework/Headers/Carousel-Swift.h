...
SWIFT_CLASS("_TtC8Carousel22CarouselViewController")
@interface CarouselViewController : UIPageViewController
- (void)setCarouselImage:(NSInteger)amount;
- (nonnull instancetype)initWithTransitionStyle:(UIPageViewControllerTransitionStyle)transitionStyle navigationOrientation:(UIPageViewControllerNavigationOrientation)navigationOrientation options:(NSDictionary<NSString *, id> * _Nullable)options OBJC_DESIGNATED_INITIALIZER;
...
@interface CarouselViewController (SWIFT_EXTENSION(Carousel)) <UIPageViewControllerDelegate>
...
@interface CarouselViewController (SWIFT_EXTENSION(Carousel)) <UIPageViewControllerDataSource>
